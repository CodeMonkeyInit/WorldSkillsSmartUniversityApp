        ...
        return (
            <form className="authorization-container container" onSubmitCapture={event => this.onSubmit(event)}>
                ...
                <label className="label-container">
                    ...
                    <input type="text" name="login" id="login-input" onChange={event => this.state.login = event.target.value} required/>
                </label>
                <label className="label-container">
                    <span className="label-auth">Пароль:</span>
                    <input type="password" name="password" id="password-input" onChange={event => this.state.password = event.target.value} required/>
                </label>
